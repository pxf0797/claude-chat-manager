...
# 检查工具是否存在
echo "🔧 检查工具脚本..."
scripts=("view-chats.sh" "chat-explorer.sh" "export-to-obsidian.sh" "export-enhanced.sh" "chat-monitor.sh")
missing=0
...
echo "🚀 快速测试..."
echo "1. 测试查看功能:"
./view-chats.sh 2>&1 | head -10

echo ""
echo "2. 测试导出功能（模拟）:"
if [ -d "$HOME/Obsidian" ]; then
    echo "✅ Obsidian目录存在"
    echo "   运行: ./export-to-obsidian.sh --help 查看导出选项"
else
...
echo ""
echo "📖 使用说明:"
echo "1. 查看聊天: ./view-chats.sh"
echo "2. 交互浏览: ./chat-explorer.sh"
echo "3. 导出到Obsidian: ./export-to-obsidian.sh"
echo "4. 增强导出: ./export-enhanced.sh"
echo "5. 自动监控: ./chat-monitor.sh daemon"
echo ""
